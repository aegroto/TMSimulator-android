...
function generateMachine(definition,transitions,steptime,alphabet_extension) {
    ...
    try {
        ...
        if(!toDefine.startsWith("<") || !toDefine.endsWith(">")) throw "syntax error in definition \""+toDefine+"\"";
        ...
        //Alphabet
        field=toDefine_s[0];
        if(!field.startsWith("{")) throw "syntax error in definition (alphabet)\""+toDefine+"\"";
        ...
        if(field.length==0) throw "syntax error in definition (blank)\""+toDefine+"\"";
        ...
        //Initial State
        field=toDefine.split(",")[1];
        if(field.length==0) throw "syntax error in definition (initial state)\""+toDefine+"\"";
        ...
        //Delta function
        field=toDefine.split(",")[1];
        if(field.length==0) throw "syntax error in definition (delta)\""+toDefine+"\"";
